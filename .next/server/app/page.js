...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 92838)), "/Users/yuda/Documents/vexpunk_frontend/app/page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 96400)), "/Users/yuda/Documents/vexpunk_frontend/app/layout.tsx"],
...
const pages = ["/Users/yuda/Documents/vexpunk_frontend/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 84352));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 67474));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 63598));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74001))
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 65521))
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ _providers_Providers)
});
...
// EXTERNAL MODULE: ./node_modules/@web3modal/ethereum/dist/index.js + 2 modules
var dist = __webpack_require__(49010);
// EXTERNAL MODULE: ./node_modules/@web3modal/react/dist/index.js
var react_dist = __webpack_require__(10634);
// EXTERNAL MODULE: ./node_modules/@wagmi/core/dist/chunk-LAFZBYO7.js + 74 modules
var chunk_LAFZBYO7 = __webpack_require__(80295);
// EXTERNAL MODULE: ./node_modules/wagmi/dist/index.js + 18 modules
var wagmi_dist = __webpack_require__(57897);
// EXTERNAL MODULE: ./node_modules/viem/dist/esm/utils/chain.js
var chain = __webpack_require__(36605);
;// CONCATENATED MODULE: ./app/_providers/vex.ts

const vex = /*#__PURE__*/ (0,chain/* defineChain */.ax)({
    id: 5522,
    name: "VEX EVM",
    network: "vex",
    nativeCurrency: {
...
;// CONCATENATED MODULE: ./app/_providers/WagmiProvider.tsx
...
const { publicClient } = (0,chunk_LAFZBYO7/* configureChains */.QB)(chains, [
    (0,dist/* w3mProvider */.X)({
        projectId
    })
]);
const wagmiConfig = (0,wagmi_dist/* createConfig */._g)({
    autoConnect: true,
    connectors: (0,dist/* w3mConnectors */.gu)({
        projectId,
        chains
    }),
    publicClient
});
const ethereumClient = new dist/* EthereumClient */.J0(wagmiConfig, chains);
const WagmiProvider = ({ children })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(react_dist/* Web3Modal */.Eg, {
                tokenImages: {
...
/* harmony default export */ const _providers_WagmiProvider = (WagmiProvider);

;// CONCATENATED MODULE: ./app/_providers/Providers.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 


const Providers = ({ children })=>{
    return /*#__PURE__*/ jsx_runtime_.jsx(_providers_WagmiProvider, {
        children: children
    });
};
/* harmony default export */ const _providers_Providers = (Providers);
...
// EXTERNAL MODULE: external "next/dist/compiled/react/jsx-runtime"
var jsx_runtime_ = __webpack_require__(56786);
// EXTERNAL MODULE: ./app/container.css
var container = __webpack_require__(28853);
// EXTERNAL MODULE: ./app/walletconnect.css
var walletconnect = __webpack_require__(79862);
// EXTERNAL MODULE: ./node_modules/@web3modal/react/dist/index.js
...
const Card = /*#__PURE__*/ react_.forwardRef(({ className, ...props }, ref)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
        ref: ref,
        className: (0,utils.cn)("mt-5 bg-gray-800 border-2 border-gray-600 p-4 rounded-lg w-1/3 min-w-max text-gray-200 rounded-xl border bg-card text-card-foreground shadow", className),
        ...props
    }));
...
// EXTERNAL MODULE: ./src/redux/store.ts + 7 modules
var store = __webpack_require__(32576);
;// CONCATENATED MODULE: ./src/components/ui/skeleton.tsx


function Skeleton({ className, ...props }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: (0,utils.cn)("animate-pulse rounded-md bg-slate-900/10 dark:bg-slate-50/10", className),
        ...props
    });
}
...
// EXTERNAL MODULE: ./node_modules/@radix-ui/react-dropdown-menu/dist/index.mjs + 14 modules
var react_dropdown_menu_dist = __webpack_require__(13821);
...
;// CONCATENATED MODULE: ./src/components/ModeToggle.tsx
...
function ModeToggle() {
    const { setTheme } = (0,next_themes_dist/* useTheme */.F)();
...
;// CONCATENATED MODULE: ./src/components/Mint/NFTCard.tsx
...
const MintSection = app_dynamic_default()(null, {
    loadableGenerated: {
        modules: [
            "/Users/yuda/Documents/vexpunk_frontend/src/components/Mint/NFTCard.tsx -> " + "./MintSection"
        ]
    },
    ssr: false
});
const NFTCard = ()=>{
    const nftName = (0,store/* useAppSelector */.C)((state)=>state.nftName.nftName);
    const nftImage = (0,store/* useAppSelector */.C)((state)=>state.nftImage.nftImage);
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(CardHeader, {
                children: [
                    ...
                    !nftImage && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(CardContent, {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "h-48 mb-4 flex items-center justify-center",
                        children: imageUri && /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                            width: 200,
                            height: 200,
                            src: imageUri,
                            alt: "NFT"
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(MintSection, {})
                ]
            })
        ]
    });
...
;// CONCATENATED MODULE: ./src/components/Mint/index.ts
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(dist/* Web3Button */.tn, {
                    balance: "show",
                    icon: "show",
                    avatar: "show"
                })
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "content",
                children: /*#__PURE__*/ jsx_runtime_.jsx(NFTCard, {})
            })
        ]
    });
}
...
function useToast() {
    const [state, setState] = react_.useState(memoryState);
    react_.useEffect(()=>{
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32576);
...
;// CONCATENATED MODULE: ./src/redux/features/nftMaxSupplySlice.ts
...
const nftMaxSupplySlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "nftsmaxsupply",
    initialState,
    reducers: {
        setNftMaxSupply: (state, action)=>{
...
const { setNftMaxSupply } = nftMaxSupplySlice.actions;
/* harmony default export */ const features_nftMaxSupplySlice = (nftMaxSupplySlice.reducer);

;// CONCATENATED MODULE: ./src/redux/features/nftBalancesOfSlice.ts
// src/redux/ipfsSlice.ts

const initialBalanceOfState = {
    balancesOf: "",
    loading: false,
    error: null
};
const nftBalancesSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "nftsbalancesof",
...
const { setNftBalances } = nftBalancesSlice.actions;
/* harmony default export */ const nftBalancesOfSlice = (nftBalancesSlice.reducer);

;// CONCATENATED MODULE: ./src/redux/features/nftTotalMintedSlice.ts

const nftTotalMintedSlice_initialState = {
    totalMinted: "",
    loading: false,
    error: null
};
const nftTotalMintedSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "nftstotalminted",
    initialState: nftTotalMintedSlice_initialState,
    reducers: {
        setNftTotalMinted: (state, action)=>{
...
const { setNftTotalMinted } = nftTotalMintedSlice.actions;
/* harmony default export */ const features_nftTotalMintedSlice = (nftTotalMintedSlice.reducer);

;// CONCATENATED MODULE: ./src/redux/features/nftImageSlice.ts
// src/redux/nftImageSlice.ts

const initialNftImageState = {
    nftImage: "",
    loading: false,
    error: null
};
const nftImageSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "nftImage",
...
const { setNftImage } = nftImageSlice.actions;
/* harmony default export */ const features_nftImageSlice = (nftImageSlice.reducer);

;// CONCATENATED MODULE: ./src/redux/features/nftNameSlice.ts
// src/redux/ipfsSlice.ts

const initialNftNameState = {
    nftName: "",
    loading: false,
    error: null
};
const nftNameSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "nftsname",
...
const { setNftName } = nftNameSlice.actions;
/* harmony default export */ const features_nftNameSlice = (nftNameSlice.reducer);

;// CONCATENATED MODULE: ./src/redux/features/accountSlice.ts
// src/redux/ipfsSlice.ts

const accountSlice_initialBalanceOfState = {
    account: "",
    loading: false,
    error: null
};
const accountsSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "account",
    initialState: accountSlice_initialBalanceOfState,
    reducers: {
...
const { setaccounts } = accountsSlice.actions;
/* harmony default export */ const accountSlice = (accountsSlice.reducer);

// EXTERNAL MODULE: ./node_modules/react-redux/lib/index.js
var lib = __webpack_require__(8250);
;// CONCATENATED MODULE: ./src/redux/features/nftDescriptionSlice.ts
// src/redux/nftDescriptionSlice.ts

const initialNftDescriptionState = {
    nftDescription: "",
    loading: false,
    error: null
};
const nftDescriptionSlice = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "nftDescription",
...
const { setNftDescription } = nftDescriptionSlice.actions;
/* harmony default export */ const features_nftDescriptionSlice = (nftDescriptionSlice.reducer);
...
const store = (0,redux_toolkit_cjs_production_min.configureStore)({
    reducer: {
        ...
        nftMaxSupply: features_nftMaxSupplySlice,
        nftTotalMinted: features_nftTotalMintedSlice,
        nftName: features_nftNameSlice,
        nftImage: features_nftImageSlice,
        nftDescription: features_nftDescriptionSlice,
...
;// CONCATENATED MODULE: ./src/components/theme-provider.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/Users/yuda/Documents/vexpunk_frontend/src/components/theme-provider.tsx`)
...
const Providers_proxy = (0,module_proxy.createProxy)(String.raw`/Users/yuda/Documents/vexpunk_frontend/app/_providers/Providers.tsx`)
...
const provider_proxy = (0,module_proxy.createProxy)(String.raw`/Users/yuda/Documents/vexpunk_frontend/src/redux/provider.tsx`)
...
const toaster_proxy = (0,module_proxy.createProxy)(String.raw`/Users/yuda/Documents/vexpunk_frontend/src/components/ui/toaster.tsx`)
                ...
                /*#__PURE__*/ jsx_runtime_.jsx("body", {
                    ...
                    children: /*#__PURE__*/ jsx_runtime_.jsx(e0, {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx(Providers, {
                            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(provider_e0, {
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/yuda/Documents/vexpunk_frontend/app/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [587,818], () => (__webpack_exec__(58363)));
